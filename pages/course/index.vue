              ...
              <li v-for="item in data.rows" :key="item.id">
                <div class="cc-l-wrap">
                  <section class="course-img">
                    <img :src=" 'http://localhost:8080'+item.coverPicturePath" class="img-responsive" :alt="item.title">
                    <div class="cc-mask">
                      <a :href="'/course/'+item.id" title="开始学习" class="comm-btn c-btn-1">开始学习</a>
                    </div>
                  </section>
                  <h3 class="hLh30 txtOf mt10">
                    <a :href="'/course/'+item.id" :title="item.courseName"
                       class="course-title fsize18 c-333">{{ item.courseName }}</a>
                  </h3>
                  <section class="mt10 hLh20 of">
                    <span v-if="Number(item.requireIntegral) === 0" class="fr jgTag bg-green">
                      <i class="c-fff fsize12 f-fA">免费</i>
                    </span>
                    <span class="fl jgAttr c-ccc f-fA">
                      <i class="c-999 f-fA"></i>
                      <i class="c-999 f-fA"></i>
                    </span>
                  </section>
                </div>
  ...
  methods: {
    ...
    initCourseFirst() {
      courseApi.getCourseList(1, 8, this.searchObj).then(response => {
        ...
        this.maxPage = Math.ceil(this.total / 8);
